...
public class DatabaseCopyHelper extends SQLiteOpenHelper {
    ...
    private boolean checkDataBase(){
        ...
        return checkDB != null; // if checkDB is not-null return true, otherwise return false
    }
    ...
    public void createDataBase() throws IOException{
        ...
        if(dbExist){
            ...
            //Toast.makeText(myContext.getApplicationContext(),"Database is already exist", Toast.LENGTH_SHORT).show();
        }else{
    ...
    public void openDataBase() throws SQLException {
        ...
        //Toast.makeText(myContext.getApplicationContext(),"Database is opened",Toast.LENGTH_SHORT).show();
